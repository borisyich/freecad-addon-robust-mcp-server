            ...
            "tools": {
                ...
                "selection": {
                    ...
                    "tools": [
                        {
                            "name": "selection",
                            "description": "Get, set, or clear the GUI selection",
                            "key_params": ["action", "object_names", "doc_name"],
                        },
                    ],
                },
                "partdesign": {
                ...
                "sketcher_constraints": {
                    "description": "Batch Sketcher constraint editing and diagnostics",
                    "note": "All requested edits run in one transaction and one recompute",
                    "tools": [
                        {
                ...
                "view": {
                    ...
                    "tools": [
                        ...
                        {
                            "name": "fit_all",
                            "description": "Fit all visible objects in the current view",
                            "key_params": ["doc_name"],
                        },
                        {
                        ...
                        {
                            "name": "workbench",
                            "description": "List or activate FreeCAD workbenches",
                            "key_params": ["action", "workbench_name"],
                        },
                    ],
                },
                "undo_redo": {
                    "description": "Undo, redo, and history status",
                    "tools": [
                        {
                            "name": "history",
                            "description": "Undo, redo, or inspect document history",
                            "key_params": ["action", "doc_name"],
                        },
                    ],
                },
                "export_import": {
