...
5. After an additive operation require a valid one-solid result, the new feature as Body Tip, and positive `added_volume`. After a subtractive operation require positive `removed_volume`.
